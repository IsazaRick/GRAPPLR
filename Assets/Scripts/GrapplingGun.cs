...
public class GrapplingGun : MonoBehaviour
{
    ...
    public LayerMask whatIsGrappleable, WiGObj;
    public Transform gunTip, camera, player, obj;
    ...
    void StartGrapple()
    {
        ...
        else if (Physics.Raycast(camera.position, camera.forward, out hit, maxDistance, WiGObj))
        {
            grapplePoint = hit.point;
